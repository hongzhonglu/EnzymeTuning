...
def main():
    ...
    path_parameters = 'gan/kcat_data_1000.h5'
    f = h5py.File(path_parameters, 'r')
    #load rxnlist(kcat_name)
    with open('data/sylogin/parameter.pkl', 'rb') as file:
        parameter_names = pickle.load(file)

    # fetch training set eigenvalues
    path_stability = 'gan/pro_data_1000.csv'
    ...
    number_of_models = 500  # No of kinetic models
    parameter_set_dim = 40  # No of kinetic parameters in model
    ...
    for j in range(50):
        ...
        # save everything
        exp_id = 'test'+str(j)
        savepath = f'gan/gan_input/{exp_id}'
        ...
        savepath = f'gan/gan_output/{exp_id}/'
        ...
        #load new kcat
        kcat_new_name = f'gan/gan_output/test{j}/repeat_{repeats-1}/490_r.npy'
        #kcat_new_name = f'gan/gan_output/test{j}/repeat_{repeats - 1}/0_r.npy'
        ...
        savepath_sta = f'gan/gan_output/test{j}'
        ...
        path_parameters = f'gan/gan_input/test{j}/kcat_data_1000.h5'
