...
def main() :
    ...
    h5_file_path = 'data/gan_input_all/kcat_data_both_1000.h5'
    ...
    with Pool (processes=num_cpus) as pool :
        args = [(
            j, growthdata, growthdata_train, max_growth_train, eModel, model, kcat_final, proteomicsdata_Clim,
            proteomicsdata_Nlim, train_type, rxn2block) for
    ...
    toy_data.to_csv ('data/gan_input_all/pro_data_1000_both.csv', index=False)
