...
from src.code_generation_preparation import changeMedia
from src.code_generation_preparation import anaerobicModel
...
def rmsecal(model , model_cobra , data , constrain , objective , osenseStr , prot_cost_info_id , prot_cost_info_value ,prot_cost_info,
    ...
    for i in range (len (data[: , 0])):
        ...
        ex_mets = ['growth' , data[i , 1] + " exchange" , 'acetate exchange' , 'ethanol exchange' ,
        ...
        with model_cobra as model_tmp:
            ...
            model_tmp = changeMedia (model , model_tmp , data[i , 1] , data[i , 15])  # 'D-glucose'
